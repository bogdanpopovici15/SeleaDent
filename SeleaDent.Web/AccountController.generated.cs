...
namespace SeleaDent.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : SeleaDent.Web.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, SeleaDent.Web.Models.LoginViewModel model);
